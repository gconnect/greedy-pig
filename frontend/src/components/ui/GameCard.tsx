...
const handleNavigate = (id: string, action: string) => {
  ...
  return (
    <div key={game.id} className="max-w-sm px-6 pt-6 pb-2 rounded-xl shadow-lg transform hover:scale-105 transition duration-500">
            ...
            <div className="my-4">
              ...
              <button onClick={() => handleNavigate(game.id, 'join')} className="mt-4 text-xl w-full text-white bg-indigo-600 py-2 rounded-xl shadow-lg">
                Join
              </button>
            </div>
          </div>
