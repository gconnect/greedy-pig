    ...
    <div className="container my-24 mx-auto md:px-6">
      <section className="text-center">
        <h2 className="mb-10 md:mb-32 text-3xl font-bold">
          ...
          <span className="text-primary dark:text-primary-400"> be proud</span>
        </h2>
        <div className="grid md:grid-cols-3 lg:gap-x-12">
          <div className="mb-12 md:mb-0">
            <div className="mb-6 inline-block rounded-md bg-primary-100 p-4 text-primary">
              ...
              >
                <path d="M64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H64zm64 96a32 32 0 1 1 0 64 32 32 0 1 1 0-64zm64 128a32 32 0 1 1 64 0 32 32 0 1 1 -64 0zm128 64a32 32 0 1 1 0 64 32 32 0 1 1 0-64z"></path>
              </svg>
            </div>
            <h3 className="mb-4 text-2xl font-bold text-primary dark:text-primary-400">
              1000
            </h3>
            <h5 className="text-lg font-mediu">Games Played</h5>
          </div>

          <div className="mb-12 md:mb-0">
            <div className="mb-6 inline-block rounded-md bg-primary-100 p-4 text-primary">
              <svg
                className="w-[25px] h-[25px] fill-red"
                viewBox="0 0 512 512"
                xmlns="http://www.w3.org/2000/svg"
              >
            ...
            <h5 className="text-lg font-medium">USD Won</h5>
          </div>
          ...
          <div className="mb-12 md:mb-0">
            ...
            <h5 className="text-lg font-medium">Earned</h5>
          </div>
        </div>
      </section>
    </div>
