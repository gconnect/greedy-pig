...
<div className="bg-white py-6 sm:py-8 lg:py-12">
  <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
    <h2 className="mb-4 text-center text-2xl font-bold text-gray-800 md:mb-8 lg:text-3xl">Trusted by the best</h2>

    <div className="grid grid-cols-2 gap-6 rounded-lg bg-gray-100 p-6 sm:h-40 sm:content-evenly md:grid-cols-4">
      <div className="flex justify-center text-gray-400">
        <svg className="h-6 w-auto sm:h-8 lg:h-10" width="154" height="39" viewBox="0 0 154 39" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="flex justify-center text-gray-400">
        <svg className="h-6 w-auto sm:h-8 lg:h-10" width="186" height="39" viewBox="0 0 186 39" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="flex justify-center text-gray-400">
        <svg className="h-6 w-auto sm:h-8 lg:h-10" width="173" height="39" viewBox="0 0 173 39" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="flex justify-center text-gray-400">
        <svg className="h-6 w-auto sm:h-8 lg:h-10" width="146" height="39" viewBox="0 0 146 39" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
